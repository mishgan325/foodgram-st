...
from .serializers import AvatarUpdateSerializer, UserGetSerializer, IngredientSerializer, SubscriptionCreateSerializer, SubscriptionReadSerializer
...
class RecipeViewSet(ModelViewSet):
    ...
    def download_shopping_cart(self, request):
        user = request.user
        # Получаем все ингредиенты из корзины пользователя
        ingredients = (
